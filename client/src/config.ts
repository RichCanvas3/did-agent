...
export const WEBDID_KEY=import.meta.env.VITE_WEBDID_KEY
export const ETHRDID_KEY=import.meta.env.VITE_ETHRDID_KEY
export const EOA_KEY=import.meta.env.VITE_EOA_KEY
