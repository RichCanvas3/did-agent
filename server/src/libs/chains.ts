import {
  ...
  export const CHAIN_IDS_TO_RPC_URLS: Record<number, string> = {
    [SupportedChainId.ETH_MAINNET]: process.env.ETHERUM_RPC_URL ?? "",
    [SupportedChainId.OPTIMISM_MAINNET]: process.env.OPTIMISM_RPC_URL ?? "",
    [SupportedChainId.BASE_MAINNET]: "https://mainnet.base.org",
    [SupportedChainId.LINEA_MAINNET]: process.env.LINEA_RPC_URL ?? "",
    ...
    [SupportedChainId.LINEA_SEPOLIA]: process.env.LINEA_SEPOLIA_RPC_URL ?? "",
    [SupportedChainId.BASE_SEPOLIA]: process.env.BASE_SEPOLIA_RPC_URL ?? "",
    ...
    [SupportedChainId.OPTIMISM_SEPOLIA]: process.env.OPTIMISM_SEPOLIA_RPC_URL ?? "",
  ...
  export const CHAIN_IDS_TO_BUNDLER_URL: Record<number, string> = {
    [SupportedChainId.ETH_MAINNET]: process.env.ETHERUM_BUNDLER_URL ?? "",
    [SupportedChainId.OPTIMISM_MAINNET]: process.env.OPTIMISM_BUNDLER_URL ?? "",
    [SupportedChainId.BASE_MAINNET]: process.env.BASE_SEPOLIA_BUNDLER_URL ?? "",
    [SupportedChainId.LINEA_MAINNET]: process.env.LINEA_BUNDLER_URL ?? "",
    ...
    [SupportedChainId.OPTIMISM_SEPOLIA]: process.env.OPTIMISM_SEPOLIA_BUNDLER_URL ?? "",
